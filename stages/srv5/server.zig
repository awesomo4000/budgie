...
const bg_budget: i64 = 400;
const bg_period_ms: i64 = 50;
const bg_quantum: i64 = 100;
...
const App = struct {
    ...
    fn stepBackground(a: *App, t: TaskId) void {
        ...
        if (a.s.reasonFor(t) == .deadline) {
            a.s.refund(t, bg_budget, 0);
            a.s.arm(t, nowMs() + bg_period_ms);
        }

        const t0 = nowNs();
        if (!a.s.chargeTo(t, .background, bg_quantum)) {
...
pub fn main(init: std.process.Init.Minimal) !void {
    ...
    a.s.admit(background_task, bg_budget, 0);
    a.s.arm(background_task, nowMs() + bg_period_ms);

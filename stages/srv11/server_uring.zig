...
const Reactor = @import("reactor_uring.zig").Reactor;
...
const App = struct {
    ...
    fn doAccept(a: *App) void {
        ...
        while (burst < K.accept_burst) : (burst += 1) {
            ...
            a.s.admit(t, 0, K.cleanup_reserve); // grant arrives via topUp
    ...
    fn park(a: *App, t: TaskId, c: *Conn, i: @import("reactor_uring.zig").Interest) void {
        a.r.watch(t, c.fd, i);
    }
...
pub fn main(init: std.process.Init.Minimal) !void {
    ...
    std.debug.print(
        "\nsteps={d} accepted={d} served={d} waits={d} avg_armed={d} rearms={d}\n  io_uring: enters={d} sqes={d} sqes_per_enter={d} overflow={d}\n",
        .{ a.steps, a.accepted, a.served, a.r.waits, if (a.r.waits > 0) a.r.fds_polled / a.r.waits else 0, a.s.rearms,
           a.r.enters, a.r.sqes_total, if (a.r.enters > 0) a.r.sqes_total / a.r.enters else 0, a.r.overflow_submits },
    );
